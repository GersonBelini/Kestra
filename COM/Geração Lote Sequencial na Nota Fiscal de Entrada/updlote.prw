...
/*/
//--------------------------------------------------------------------
User Function UPDLOTE( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDLOTE" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDLOTE" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'SEQUENCIAL LOTE'														, ; //X2_NOME
	'SEQUENCIAL LOTE'														, ; //X2_NOMESPA
	'SEQUENCIAL LOTE'														, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX5, { ;
	...
	'00'																	, ; //X5_TABELA
	'Z1'																	, ; //X5_CHAVE
	'CRITERIOS RATEIO'														, ; //X5_DESCRI
	'CRITERIOS RATEIO'														, ; //X5_DESCSPA
	'CRITERIOS RATEIO'														} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'Z1'																	, ; //X5_TABELA
	'01'																	, ; //X5_CHAVE
	'HORAS HOMEM TRABALHADAS'												, ; //X5_DESCRI
	'HORAS HOMEM TRABALHADAS'												, ; //X5_DESCSPA
	'HORAS HOMEM TRABALHADAS'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z1'																	, ; //X5_TABELA
	'02'																	, ; //X5_CHAVE
	'Horas Maquinas Trabalhadas'											, ; //X5_DESCRI
	'Horas Maquinas Trabalhadas'											, ; //X5_DESCSPA
	'Horas Maquinas Trabalhadas'											} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z1'																	, ; //X5_TABELA
	'03'																	, ; //X5_CHAVE
	'Numero de Funcionarios'												, ; //X5_DESCRI
	'Numero de Funcionarios'												, ; //X5_DESCSPA
	'Numero de Funcionarios'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z1'																	, ; //X5_TABELA
	'04'																	, ; //X5_CHAVE
	'Numero de Vidas'														, ; //X5_DESCRI
	'Numero de Vidas'														, ; //X5_DESCSPA
	'Numero de Vidas'														} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z1'																	, ; //X5_TABELA
	'05'																	, ; //X5_CHAVE
	'Energia Eletrica'														, ; //X5_DESCRI
	'Energia Eletrica'														, ; //X5_DESCSPA
	'Energia Eletrica'														} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'Z1'																	, ; //X5_TABELA
	'99'																	, ; //X5_CHAVE
	'Padrao Sistema'														, ; //X5_DESCRI
	'Padrao Sistema'														, ; //X5_DESCSPA
	'Padrao Sistema'														} ) //X5_DESCENG
...
//
aHlpPor := {}
aAdd( aHlpPor, 'ANO/MES' )

PutHelp( "PZ7_ANOMES ", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z7_ANOMES" )

aHlpPor := {}
aAdd( aHlpPor, 'SEQUENCIA' )

PutHelp( "PZ7_SEQUEN ", aHlpPor, {}, {}, .T. )
AutoGrLog( "Atualizado o Help do campo " + "Z7_SEQUEN" )
