...
Begin Sequence
   ...
   HEADER_P->AVG_C04_60:=ALLTRIM("TEL.: "+AllTrim(cEXP_FONE)+" FAX: "+AllTrim(cEXP_FAX)+" CNPJ: "+AllTrim(SA2->A2_CGC)) //LRS 8/11/2013 - Colocado o campo CNPJ no titulo do documento
...
//   HEADER_P->AVG_C02_20 := EEC->EEC_PREEMB
   If Type("lDocImpInv") <> "U" .And. lDocImpInv  // GFP - 27/11/2013
   ...
   && Andre Borin - TOTVS IP - 22/06/2015
...
//   ENDIF
   ...
   && Dandos bancarios   
   HEADER_P->AVG_C30_60 := EEC->EEC_ZZBANK
   HEADER_P->AVG_C29_60 := EEC->EEC_ZZSWIF
   HEADER_P->AVG_C20_20 := EEC->EEC_ZZAGEN
   HEADER_P->AVG_C21_20 := EEC->EEC_ZZACCO
