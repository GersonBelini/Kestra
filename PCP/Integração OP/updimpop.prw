...
/*/
//--------------------------------------------------------------------
User Function UPDIMPOP( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDIMPOP" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDIMPOP" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'INTEGRACAO ORDEM PRODUCAO'												, ; //X2_NOME
	'INTEGRACAO ORDEM PRODUCAO'												, ; //X2_NOMESPA
	'INTEGRACAO ORDEM PRODUCAO'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Previsao Ini'															, ; //X3_TITULO
	'Prev. Inic.'															, ; //X3_TITSPA
	'Init.Forec.'															, ; //X3_TITENG
	'Data prevista de inicio'												, ; //X3_DESCRIC
	'Fecha prevista de Inicio'												, ; //X3_DESCSPA
	'Initial Forecast Date'													, ; //X3_DESCENG
	'@D'																	, ; //X3_PICTURE
	'A650DatPri()'															, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Entrega'																, ; //X3_TITSPA
	'Delivery'																, ; //X3_TITENG
	'Data prevista de entrega'												, ; //X3_DESCRIC
	'Fecha prevista de Entrega'												, ; //X3_DESCSPA
	'Delivery Estimated Date'												, ; //X3_DESCENG
	'@D'																	, ; //X3_PICTURE
	'A650DatPrf()'															, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Situacion'																, ; //X3_TITSPA
	'Situation'																, ; //X3_TITENG
	'Situacao da O.P.'														, ; //X3_DESCRIC
	'Situacion de la O.P.'													, ; //X3_DESCSPA
	'P.O. Situation'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	'Pertence("SUN ").And.A650Status()'										, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'"N"'																	, ; //X3_RELACAO
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'U=Suspensa;S=Sacramentada;N=Normal'									, ; //X3_CBOX
	'U=Suspendida;S=Formalizada;N=Normal'									, ; //X3_CBOXSPA
	'U=Suspended;S=Validated;N=Normal'										, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'3=INCLUSAO;5=EXCLUSAO'													, ; //X3_CBOX
	'3=INCLUSAO;5=EXCLUSAO'													, ; //X3_CBOXSPA
	'3=INCLUSAO;5=EXCLUSAO'													, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'NUM. CORRIDA'															, ; //X3_TITULO
	'NUM. CORRIDA'															, ; //X3_TITSPA
	'NUM. CORRIDA'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	0																		, ; //X3_DECIMAL
	'PREVISAO INI'															, ; //X3_TITULO
	'PREVISAO INI'															, ; //X3_TITSPA
	'PREVISAO INI'															, ; //X3_TITENG
	'PREVISAO INICIO'														, ; //X3_DESCRIC
	'PREVISAO INICIO'														, ; //X3_DESCSPA
	'PREVISAO INICIO'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'CODIGO ANTIGO'															, ; //X3_DESCRIC
	'CODIGO ANTIGO'															, ; //X3_DESCSPA
	'CODIGO ANTIGO'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'NUM. REVISAO'															, ; //X3_TITULO
	'NUM. REVISAO'															, ; //X3_TITSPA
	'NUM. REVISAO'															, ; //X3_TITENG
	'NUMERO REVISAO'														, ; //X3_DESCRIC
	'NUMERO REVISAO'														, ; //X3_DESCSPA
	'NUMERO REVISAO'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'HOMOG. MIN.'															, ; //X3_TITSPA
	'HOMOG. MIN.'															, ; //X3_TITENG
	'HOMEGENEIZACAO MINIMA'													, ; //X3_DESCRIC
	'HOMEGENEIZACAO MINIMA'													, ; //X3_DESCSPA
	'HOMEGENEIZACAO MINIMA'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'HOMOG. MAX.'															, ; //X3_TITSPA
	'HOMOG. MAX.'															, ; //X3_TITENG
	'HOMEGENEIZACAO MAXIMA'													, ; //X3_DESCRIC
	'HOMEGENEIZACAO MAXIMA'													, ; //X3_DESCSPA
	'HOMEGENEIZACAO MAXIMA'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'PRESSAO MIN.'															, ; //X3_TITULO
	'PRESSAO MIN.'															, ; //X3_TITSPA
	'PRESSAO MIN.'															, ; //X3_TITENG
	'PRESSAO MINIMA'														, ; //X3_DESCRIC
	'PRESSAO MINIMA'														, ; //X3_DESCSPA
	'PRESSAO MINIMA'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'PRESSAO MAX.'															, ; //X3_TITULO
	'PRESSAO MAX.'															, ; //X3_TITSPA
	'PRESSAO MAX.'															, ; //X3_TITENG
	'PRESSAO MAXIMA'														, ; //X3_DESCRIC
	'PRESSAO MAXIMA'														, ; //X3_DESCSPA
	'PRESSAO MAXIMA'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'CARIMBO NORM'															, ; //X3_TITULO
	'CARIMBO NORM'															, ; //X3_TITSPA
	'CARIMBO NORM'															, ; //X3_TITENG
	'CARIMBO NORMA'															, ; //X3_DESCRIC
	'CARIMBO NORMA'															, ; //X3_DESCSPA
	'CARIMBO NORMA'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'TP SILICATO'															, ; //X3_TITULO
	'TP SILICATO'															, ; //X3_TITSPA
	'TP SILICATO'															, ; //X3_TITENG
	'TIPO SILICATO'															, ; //X3_DESCRIC
	'TIPO SILICATO'															, ; //X3_DESCSPA
	'TIPO SILICATO'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=ELETRODO REVESTIDO;2=ARAME TUBULAR;3=ORDEM DE PESAGEM;4=ORDEM DE PRODUCAO', ; //X3_CBOX
	'1=ELETRODO REVESTIDO;2=ARAME TUBULAR;3=ORDEM DE PESAGEM;4=ORDEM DE PRODUCAO', ; //X3_CBOXSPA
	'1=ELETRODO REVESTIDO;2=ARAME TUBULAR;3=ORDEM DE PESAGEM;4=ORDEM DE PRODUCAO', ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=EXPORTADO PELO KESTRA;2=ERRO NA INTEGRACAO;3=INTEGRADO COM SUCESSO'		, ; //X3_CBOX
	'1=EXPORTADO PELO KESTRA;2=ERRO NA INTEGRACAO;3=INTEGRADO COM SUCESSO'		, ; //X3_CBOXSPA
	'1=EXPORTADO PELO KESTRA;2=ERRO NA INTEGRACAO;3=INTEGRADO COM SUCESSO'		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Norma DIN'																, ; //X3_TITSPA
	'Norma DIN'																, ; //X3_TITENG
	'Norma DIN'																, ; //X3_DESCRIC
	'Norma DIN'																, ; //X3_DESCSPA
	'Norma DIN'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tp. OP. Kest'															, ; //X3_TITULO
	'Tp. OP. Kest'															, ; //X3_TITSPA
	'Tp. OP. Kest'															, ; //X3_TITENG
	'Tp. OP. Kestra'														, ; //X3_DESCRIC
	'Tp. OP. Kestra'														, ; //X3_DESCSPA
	'Tp. OP. Kestra'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'ZC2'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'ZC2_FILIAL+ZC2_IDINT'													, ; //CHAVE
	'ID Integracao'															, ; //DESCRICAO
	'ID Integracao'															, ; //DESCSPA
	'ID Integracao'															, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
