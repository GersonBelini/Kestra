...
/*/
//--------------------------------------------------------------------
User Function UPDIMPRO( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDIMPRO" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDIMPRO" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX3, { ;
	...
	'Layout OP'																, ; //X3_TITSPA
	'Layout OP'																, ; //X3_TITENG
	'Layout OP'																, ; //X3_DESCRIC
	'Layout OP'																, ; //X3_DESCSPA
	'Layout OP'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	'1=OP Eletrodo Revestido;2=OP Arame Tubular;3=OP de Pesagem;4=OP de Corte'	, ; //X3_CBOX
	'1=OP Eletrodo Revestido;2=OP Arame Tubular;3=OP de Pesagem;4=OP de Corte'	, ; //X3_CBOXSPA
	'1=OP Eletrodo Revestido;2=OP Arame Tubular;3=OP de Pesagem;4=OP de Corte'	, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Codigo Kestr'															, ; //X3_TITULO
	'Codigo Kestr'															, ; //X3_TITSPA
	'Codigo Kestr'															, ; //X3_TITENG
	'Codigo Kestra'															, ; //X3_DESCRIC
	'Codigo Kestra'															, ; //X3_DESCSPA
	'Codigo Kestra'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'1=Eletrodo Revestido;2=Arame Tubular;3=Pesagem;4=Corte'				, ; //X3_CBOX
	'1=Eletrodo Revestido;2=Arame Tubular;3=Pesagem;4=Corte'				, ; //X3_CBOXSPA
	'1=Eletrodo Revestido;2=Arame Tubular;3=Pesagem;4=Corte'				, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	'Extrusora'																, ; //X3_TITSPA
	'Extrusora'																, ; //X3_TITENG
	'Extrusora'																, ; //X3_DESCRIC
	'Extrusora'																, ; //X3_DESCSPA
	'Extrusora'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Press Min'																, ; //X3_TITSPA
	'Press Min'																, ; //X3_TITENG
	'Press Min'																, ; //X3_DESCRIC
	'Press Min'																, ; //X3_DESCSPA
	'Press Min'																, ; //X3_DESCENG
	'@E 9,999.99'															, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Press Max'																, ; //X3_TITSPA
	'Press Max'																, ; //X3_TITENG
	'Press Max'																, ; //X3_DESCRIC
	'Press Max'																, ; //X3_DESCSPA
	'Press Max'																, ; //X3_DESCENG
	'@E 9,999.99'															, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Carimbo Kest'															, ; //X3_TITULO
	'Carimbo Kest'															, ; //X3_TITSPA
	'Carimbo Kest'															, ; //X3_TITENG
	'Carimbo Kestra'														, ; //X3_DESCRIC
	'Carimbo Kestra'														, ; //X3_DESCSPA
	'Carimbo Kestra'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Carim. Norma'															, ; //X3_TITULO
	'Carim. Norma'															, ; //X3_TITSPA
	'Carim. Norma'															, ; //X3_TITENG
	'Carim. Norma'															, ; //X3_DESCRIC
	'Carim. Norma'															, ; //X3_DESCSPA
	'Carim. Norma'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Laminadora'															, ; //X3_TITULO
	'Laminadora'															, ; //X3_TITSPA
	'Laminadora'															, ; //X3_TITENG
	'Laminadora'															, ; //X3_DESCRIC
	'Laminadora'															, ; //X3_DESCSPA
	'Laminadora'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SC2'																	, ; //INDICE
	'B'																		, ; //ORDEM
	'C2_FILIAL+C2_ZZNCORR+C2_ZZREQUA+C2_PRODUTO'							, ; //CHAVE
	'Nro. Corrida+Requalificac+Produto'										, ; //DESCRICAO
	'Nro. Corrida+Requalificac+Producto'									, ; //DESCSPA
	'Nro. Corrida+Requalificac+Producto'									, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	'CORRIDA'																, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSX6, { ;
	...
	''																		, ; //X6_DSCSPA2
	''																		, ; //X6_DSCENG2
	'pedidos.compras@kestra.com.br'											, ; //X6_CONTEUD
	'pedidos.compras@kestra.com.br'											, ; //X6_CONTSPA
	'pedidos.compras@kestra.com.br'											, ; //X6_CONTENG
	'U'																		, ; //X6_PROPRI
	''																		, ; //X6_VALID
	''																		, ; //X6_INIT
	''																		, ; //X6_DEFPOR
