...
/*/
//--------------------------------------------------------------------
User Function UPDPROEX( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDPROEX" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDPROEX" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'CADASTRO NORMA DIN'													, ; //X2_NOME
	'CADASTRO NORMA DIN'													, ; //X2_NOMESPA
	'CADASTRO NORMA DIN'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'CADASTRO NORMA EPR'													, ; //X2_NOME
	'CADASTRO NORMA EPR'													, ; //X2_NOMESPA
	'CADASTRO NORMA EPR'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'CADASTRO NORMA ASME'													, ; //X2_NOME
	'CADASTRO NORMA ASME'													, ; //X2_NOMESPA
	'CADASTRO NORMA ASME'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'SEQUENCIAL NUMERO CORRIDA'												, ; //X2_NOME
	'SEQUENCIAL NUMERO CORRIDA'												, ; //X2_NOMESPA
	'SEQUENCIAL NUMERO CORRIDA'												, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'SEQUENCIAL ETIQUETA'													, ; //X2_NOME
	'SEQUENCIAL ETIQUETA'													, ; //X2_NOMESPA
	'SEQUENCIAL ETIQUETA'													, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	'IDASME'																, ; //X3_TITSPA
	'IDASME'																, ; //X3_TITENG
	'Id da tabela ASME'														, ; //X3_DESCRIC
	'Id da tabela ASME'														, ; //X3_DESCSPA
	'Id da tabela ASME'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistCPO("SZ3",M->B1_ZZASME)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'IDEPR'																	, ; //X3_TITSPA
	'IDEPR'																	, ; //X3_TITENG
	'Id da tabela EPR'														, ; //X3_DESCRIC
	'Id da tabela EPR'														, ; //X3_DESCSPA
	'Id da tabela EPR'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistCPO("SZ2",M->B1_ZZNEPR)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'IDDIN'																	, ; //X3_TITSPA
	'IDDIN'																	, ; //X3_TITENG
	'Id da tabela DIN'														, ; //X3_DESCRIC
	'Id da tabela DIN'														, ; //X3_DESCSPA
	'Id da tabela DIN'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistCPO("SZ1",M->B1_ZZNDIN)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tensao Min'															, ; //X3_TITULO
	'Tensao Min'															, ; //X3_TITSPA
	'Tensao Min'															, ; //X3_TITENG
	'Tensao Minima'															, ; //X3_DESCRIC
	'Tensao Minima'															, ; //X3_DESCSPA
	'Tensao Minima'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Tensao Max'															, ; //X3_TITULO
	'Tensao Max'															, ; //X3_TITSPA
	'Tensao Max'															, ; //X3_TITENG
	'Tensao Maxima'															, ; //X3_DESCRIC
	'Tensao Maxima'															, ; //X3_DESCSPA
	'Tensao Maxima'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Stick-Out Mi'															, ; //X3_TITULO
	'Stick-Out Mi'															, ; //X3_TITSPA
	'Stick-Out Mi'															, ; //X3_TITENG
	'Stick-Out Minima'														, ; //X3_DESCRIC
	'Stick-Out Minima'														, ; //X3_DESCSPA
	'Stick-Out Minima'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Stick-Out Ma'															, ; //X3_TITULO
	'Stick-Out Ma'															, ; //X3_TITSPA
	'Stick-Out Ma'															, ; //X3_TITENG
	'Stick-Out Maxima'														, ; //X3_DESCRIC
	'Stick-Out Maxima'														, ; //X3_DESCSPA
	'Stick-Out Maxima'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Corrente Min'															, ; //X3_TITULO
	'Corrente Min'															, ; //X3_TITSPA
	'Corrente Min'															, ; //X3_TITENG
	'Corrente Minima'														, ; //X3_DESCRIC
	'Corrente Minima'														, ; //X3_DESCSPA
	'Corrente Minima'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Corrente Max'															, ; //X3_TITULO
	'Corrente Max'															, ; //X3_TITSPA
	'Corrente Max'															, ; //X3_TITENG
	'Corrente Maxima'														, ; //X3_DESCRIC
	'Corrente Maxima'														, ; //X3_DESCSPA
	'Corrente Maxima'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Vazao Min'																, ; //X3_TITSPA
	'Vazao Min'																, ; //X3_TITENG
	'Vazao Minima'															, ; //X3_DESCRIC
	'Vazao Minima'															, ; //X3_DESCSPA
	'Vazao Minima'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Vazao Max'																, ; //X3_TITSPA
	'Vazao Max'																, ; //X3_TITENG
	'Vazao Maxima'															, ; //X3_DESCRIC
	'Vazao Maxima'															, ; //X3_DESCSPA
	'Vazao Maxima'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Gas Protecao'															, ; //X3_TITULO
	'Gas Protecao'															, ; //X3_TITSPA
	'Gas Protecao'															, ; //X3_TITENG
	'Gas Protecao'															, ; //X3_DESCRIC
	'Gas Protecao'															, ; //X3_DESCSPA
	'Gas Protecao'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'@!'																	, ; //X3_PICTURE
	'A093Prod().And.A650IniCpo().And.AProdGrade().And.A650Campos().And.A650Quant().And.A650QtSeg()', ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'If(ExistBlock("arNormas"),ExecBlock("arNormas",.F.,.F.),.T.)'			, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nro. Corrida'															, ; //X3_TITULO
	'Nro. Corrida'															, ; //X3_TITSPA
	'Nro. Corrida'															, ; //X3_TITENG
	'Numero da Corrida'														, ; //X3_DESCRIC
	'Numero da Corrida'														, ; //X3_DESCSPA
	'Numero da Corrida'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Requalificac'															, ; //X3_TITULO
	'Requalificac'															, ; //X3_TITSPA
	'Requalificac'															, ; //X3_TITENG
	'Requalificacao'														, ; //X3_DESCRIC
	'Requalificacao'														, ; //X3_DESCSPA
	'Requalificacao'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Norma DIM'																, ; //X3_TITSPA
	'Norma DIM'																, ; //X3_TITENG
	'Norma DIM'																, ; //X3_DESCRIC
	'Norma DIM'																, ; //X3_DESCSPA
	'Norma DIM'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Norma EPR'																, ; //X3_TITSPA
	'Norma EPR'																, ; //X3_TITENG
	'Norma EPR'																, ; //X3_DESCRIC
	'Norma EPR'																, ; //X3_DESCSPA
	'Norma EPR'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Norma ASME'															, ; //X3_TITULO
	'Norma ASME'															, ; //X3_TITSPA
	'Norma ASME'															, ; //X3_TITENG
	'Norma ASME'															, ; //X3_DESCRIC
	'Norma ASME'															, ; //X3_DESCSPA
	'Norma ASME'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Ord. Prodn.'															, ; //X3_TITSPA
	'Qty Product.'															, ; //X3_TITENG
	'Ordem de Producao'														, ; //X3_DESCRIC
	'Orden de Produccion'													, ; //X3_DESCSPA
	'Production Order'														, ; //X3_DESCENG
	'@N'																	, ; //X3_PICTURE
	'ExistCpo("SC2").And.A680IniOP()'										, ; //X3_VALID
	Chr(128) + Chr(144) + Chr(128) + Chr(136) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'If(ExistBlock("geraLote"),ExecBlock("geraLote",.F.,.F.),.T.)'			, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'COD. NORMA'															, ; //X3_TITSPA
	'COD. NORMA'															, ; //X3_TITENG
	'CODIGO DA NORMA'														, ; //X3_DESCRIC
	'CODIGO DA NORMA'														, ; //X3_DESCSPA
	'CODIGO DA NORMA'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistChav("SZ1",M->Z1_NORMA)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistChav("SZ2",M->Z2_NORMA)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'€'																		, ; //X3_OBRIGAT
	'ExistChav("SZ3",M->Z3_NORMA)'											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	70																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'DESCRICAO 1'															, ; //X3_TITULO
	'DESCRICAO 1'															, ; //X3_TITSPA
	'DESCRICAO 1'															, ; //X3_TITENG
	'DESCRICAO 1'															, ; //X3_DESCRIC
	'DESCRICAO 1'															, ; //X3_DESCSPA
	'DESCRICAO 1'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Numero OP'																, ; //X3_TITSPA
	'Numero OP'																, ; //X3_TITENG
	'Numero OP'																, ; //X3_DESCRIC
	'Numero OP'																, ; //X3_DESCSPA
	'Numero OP'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Qtd. Produzi'															, ; //X3_TITULO
	'Qtd. Produzi'															, ; //X3_TITSPA
	'Qtd. Produzi'															, ; //X3_TITENG
	'Qtd. Produzida'														, ; //X3_DESCRIC
	'Qtd. Produzida'														, ; //X3_DESCSPA
	'Qtd. Produzida'														, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	4																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Seq. Etique.'															, ; //X3_TITULO
	'Seq. Etique.'															, ; //X3_TITSPA
	'Seq. Etique.'															, ; //X3_TITENG
	'Sequencial Etiqueta'													, ; //X3_DESCRIC
	'Sequencial Etiqueta'													, ; //X3_DESCSPA
	'Sequencial Etiqueta'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSIX, { ;
	'SZ4'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z4_FILIAL+Z4_GRPPRO+Z4_AMOSTRA+Z4_ANOMES'								, ; //CHAVE
	'Grupo Produt+Amostra+Ano/Mes'											, ; //DESCRICAO
	'Grupo Produt+Amostra+Ano/Mes'											, ; //DESCSPA
	'Grupo Produt+Amostra+Ano/Mes'											, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSIX, { ;
	'SZ5'																	, ; //INDICE
	'1'																		, ; //ORDEM
	'Z5_FILIAL+Z5_NUMOP+Z5_PRODUTO'											, ; //CHAVE
	'Numero OP+Produto'														, ; //DESCRICAO
	'Numero OP+Produto'														, ; //DESCSPA
	'Numero OP+Produto'														, ; //DESCENG
	'U'																		, ; //PROPRI
	''																		, ; //F3
	''																		, ; //NICKNAME
	'S'																		} ) //SHOWPESQ
...
aAdd( aSXB, { ;
	...
	'DB'																	, ; //XB_COLUNA
	'NORMA DIN'																, ; //XB_DESCRI
	'NORMA DIN'																, ; //XB_DESCSPA
	'NORMA DIN'																, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZ1'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_COLUNA
	'Cod. Norma'															, ; //XB_DESCRI
	'Cod. Norma'															, ; //XB_DESCSPA
	'Cod. Norma'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'DB'																	, ; //XB_COLUNA
	'NORMA EPR'																, ; //XB_DESCRI
	'NORMA EPR'																, ; //XB_DESCSPA
	'NORMA EPR'																, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZ2'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'NORMA ASME'															, ; //XB_DESCRI
	'NORMA ASME'															, ; //XB_DESCSPA
	'NORMA ASME'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'SZ3'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'DESCRICAO 1'															, ; //XB_DESCRI
	'DESCRICAO 1'															, ; //XB_DESCSPA
	'DESCRICAO 1'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'Z3_DESC1'																} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'03'																	, ; //XB_COLUNA
	'DESCRICAO 2'															, ; //XB_DESCRI
	'DESCRICAO 2'															, ; //XB_DESCSPA
	'DESCRICAO 2'															, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'Z3_DESC2'																} ) //XB_CONTEM
