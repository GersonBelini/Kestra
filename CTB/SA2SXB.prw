...
ฑฑบPrograma  ณSA2SXB    บAutor  ณDonizete            บ Data ณ  03/07/06   บฑฑ
...
ฑฑบ          ณ de um F3 (Fornecedor por exemplo). Neste sentido temos que บฑฑ
...
ฑฑบ          ณ Sintaxe da chamada #U_SA2SXB .                             บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
User Function SA2SXB()
	If AxInclui("SA2",0,3) == 1 // O usuแrio incluiu o registro, neste caso o ponto de entrada deve ser executado.
		U_M020INC()
	EndIf
Return