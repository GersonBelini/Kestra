...
±±³Programa  ³  BKPATF  ³ Autor ³ RICARDO BATAGLIA      ³ Data ³ 12/01/05 ³±±
...
Public _cEmpFil	:= SM0->M0_CODIGO+"/"+SM0->M0_NOME
	...
	If ParamBox(aParamBox,"Parametros",,,,.T.,,,,"BKPATF",.T.,.T.)
		If MV_PAR01 == 1
			...
			_lYesNo := MsgYesNo("Confirma backup do ativo da empresa "+_cEmpFil+"?","ATENÇÃO")
			If _lYesNo	== .F.
				Return
			EndIf
			
			MsgRun("Atualizando tabela SM2. Aguarde...","Atualização tabela SM2",{|| pUpdSM2() })
