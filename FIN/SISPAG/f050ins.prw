...
User Function F050INS()
 ...
 If _cRotina == "FINA050" .or. _cRotina == "MATA103" .or. _cRotina == "FINA750"
     ...
     SE2->E2_ZZCONTR  := _cRazao   
     SE2->E2_ZZCDREC := "2631"  // Fixo 2631 porque para terceiros é sempre este.
     SE2->E2_ZZAPURA  := LastDay(CTOD("01"+"/"+_cMes+"/"+_cAno))  //-- Competencia mes/ano referente a data de emissao da NF
