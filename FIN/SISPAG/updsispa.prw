...
ฑฑบ Programa ณ UPDSISPA บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de update dos dicionแrios para compatibiliza็ใo     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ UPDSISPA   - Gerado por EXPORDIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function UPDSISPA( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		...
		If lAuto
			If lOk
				MsgStop( "Atualiza็ใo Realizada.", "UPDSISPA" )
				dbCloseAll()
			Else
				MsgStop( "Atualiza็ใo nใo Realizada.", "UPDSISPA" )
				dbCloseAll()
			EndIf
		Else
			If lOk
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'Dig. Conta'															, ; //X3_TITSPA
	'Dig. Conta'															, ; //X3_TITENG
	'Digito Conta'															, ; //X3_DESCRIC
	'Digito Conta'															, ; //X3_DESCSPA
	'Digito Conta'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	47																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Linha Digit.'															, ; //X3_TITULO
	'Linha Digit.'															, ; //X3_TITSPA
	'Linha Digit.'															, ; //X3_TITENG
	'Linha Digit.'															, ; //X3_DESCRIC
	'Linha Digit.'															, ; //X3_DESCSPA
	'Linha Digit.'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	2																		, ; //X3_DECIMAL
	'Saldo Pg'																, ; //X3_TITULO
	'Saldo Pagar'															, ; //X3_TITSPA
	'Saldo Pagar'															, ; //X3_TITENG
	'Saldo Pagar'															, ; //X3_DESCRIC
	'Saldo Pagar'															, ; //X3_DESCSPA
	'Saldo Pagar'															, ; //X3_DESCENG
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	'SE2->E2_VALOR-(SE2->(E2_PIS+E2_COFINS+E2_CSLL+E2_DECRESC-E2_ACRESC))'		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	'S'																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	14																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Juros CNAB'															, ; //X3_TITULO
	'Juros CNAB'															, ; //X3_TITSPA
	'Juros CNAB'															, ; //X3_TITENG
	'Juros CNAB'															, ; //X3_DESCRIC
	'Juros CNAB'															, ; //X3_DESCSPA
	'Juros CNAB'															, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	14																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Vlr.Entidade'															, ; //X3_TITULO
	'Vlr.Entidade'															, ; //X3_TITSPA
	'Vlr.Entidade'															, ; //X3_TITENG
	'Valor Entidade'														, ; //X3_DESCRIC
	'Valor Entidade'														, ; //X3_DESCSPA
	'Valor Entidade'														, ; //X3_DESCENG
	'@E 99,999,999,999.99'													, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	14																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'CNPJ Contrib'															, ; //X3_TITULO
	'CNPJ Contrib'															, ; //X3_TITSPA
	'CNPJ Contrib'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	30																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nome Contrib'															, ; //X3_TITULO
	'Nome Contrib'															, ; //X3_TITSPA
	'Nome Contrib'															, ; //X3_TITENG
...
aAdd( aSX3, { ;
	...
	17																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nr Referenc'															, ; //X3_TITULO
	'Nr Referenc'															, ; //X3_TITSPA
	'Nr Referenc'															, ; //X3_TITENG
	'Num. Referencia'														, ; //X3_DESCRIC
	'Num. Referencia'														, ; //X3_DESCSPA
	'Num. Referencia'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	13																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Div Ativa/Et'															, ; //X3_TITULO
	'Div Ativa/Et'															, ; //X3_TITSPA
	'Div Ativa/Et'															, ; //X3_TITENG
	'Divida Ativa/Etiqueta'													, ; //X3_DESCRIC
	'Divida Ativa/Etiqueta'													, ; //X3_DESCSPA
	'Divida Ativa/Etiqueta'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	13																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Parc/Notific'															, ; //X3_TITULO
	'Parc/Notific'															, ; //X3_TITSPA
	'Parc/Notific'															, ; //X3_TITENG
	'Parcela/Notificacao'													, ; //X3_DESCRIC
	'Parcela/Notificacao'													, ; //X3_DESCSPA
	'Parcela/Notificacao'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Ano Base'																, ; //X3_TITSPA
	'Ano Base'																, ; //X3_TITENG
	'Ano Base IPVA'															, ; //X3_DESCRIC
	'Ano Base IPVA'															, ; //X3_DESCSPA
	'Ano Base IPVA'															, ; //X3_DESCENG
	'@E 9999'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'C๓d. Munic.'															, ; //X3_TITSPA
	'C๓d. Munic.'															, ; //X3_TITENG
	'C๓d. Municํpio'														, ; //X3_DESCRIC
	'C๓d. Municํpio'														, ; //X3_DESCSPA
	'C๓d. Municํpio'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	14																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Multa CNAB'															, ; //X3_TITULO
	'Multa CNAB'															, ; //X3_TITSPA
	'Multa CNAB'															, ; //X3_TITENG
	'Multa CNAB'															, ; //X3_DESCRIC
	'Multa CNAB'															, ; //X3_DESCSPA
	'Multa CNAB'															, ; //X3_DESCENG
	'@E 99,999,999,999.99'													, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Op็ใo Pgto.'															, ; //X3_TITULO
	'Op็ใo Pgto.'															, ; //X3_TITSPA
	'Op็ใo Pgto.'															, ; //X3_TITENG
	'Op็ใo Pgto.'															, ; //X3_DESCRIC
	'Op็ใo Pgto.'															, ; //X3_DESCSPA
	'Op็ใo Pgto.'															, ; //X3_DESCENG
	'9'																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	16																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Identif FGTS'															, ; //X3_TITULO
	'Identif FGTS'															, ; //X3_TITSPA
	'Identif FGTS'															, ; //X3_TITENG
	'Identif FGTS'															, ; //X3_DESCRIC
	'Identif FGTS'															, ; //X3_DESCSPA
	'Identif FGTS'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX7 บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX5 บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX5, { ;
	...
	'00'																	, ; //X5_TABELA
	'59'																	, ; //X5_CHAVE
	'TIPO DE PAGAMENTO - SISPAG'											, ; //X5_DESCRI
	'TIPO DE PAGO - SISPAG'													, ; //X5_DESCSPA
	'PAYMENT TYPE - SISPAG'													} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'58'																	, ; //X5_TABELA
	'01'																	, ; //X5_CHAVE
	'CRษDITO EM CONTA CORRENTE'												, ; //X5_DESCRI
	'CRษDITO EM CONTA CORRENTE'												, ; //X5_DESCSPA
	'CRษDITO EM CONTA CORRENTE'												} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'ORDEN DE PAGO DISPONIBLE CON AVISO AL BENEFICIARIO'					, ; //X5_DESCSPA
	'AVAILABLE PO WITH NOTICE FOR THE BENEFICIARY'							} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'05'																	, ; //X5_CHAVE
	'CRษDITO EM CONTA POUPANวA'												, ; //X5_DESCRI
	'CRษDITO EM CONTA POUPANวA'												, ; //X5_DESCSPA
	'CRษDITO EM CONTA POUPANวA'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'06'																	, ; //X5_CHAVE
	'CRษDITO EM CONTA CORRENTE DE MESMA TITULARIDADE'						, ; //X5_DESCRI
	'CRษDITO EM CONTA CORRENTE DE MESMA TITULARIDADE'						, ; //X5_DESCSPA
	'CRษDITO EM CONTA CORRENTE DE MESMA TITULARIDADE'						} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'58'																	, ; //X5_TABELA
	'10'																	, ; //X5_CHAVE
	'ORDEM DE PAGAMENTO ภ DISPOSIวรO'										, ; //X5_DESCRI
	'ORDEM DE PAGAMENTO ภ DISPOSIวรO'										, ; //X5_DESCSPA
	'ORDEM DE PAGAMENTO ภ DISPOSIวรO'										} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'13'																	, ; //X5_CHAVE
	'PAGAMENTO DE CONCESSIONมRIAS'											, ; //X5_DESCRI
	'PAGAMENTO DE CONCESSIONมRIAS'											, ; //X5_DESCSPA
	'PAGAMENTO DE CONCESSIONมRIAS'											} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'16'																	, ; //X5_CHAVE
	'DARF NORMAL'															, ; //X5_DESCRI
	'DARF NORMAL'															, ; //X5_DESCSPA
	'DARF NORMAL'															} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'17'																	, ; //X5_CHAVE
	'GPS - GUIA DA PREVIDสNCIA SOCIAL'										, ; //X5_DESCRI
	'GPS - GUIA DA PREVIDสNCIA SOCIAL'										, ; //X5_DESCSPA
	'GPS - GUIA DA PREVIDสNCIA SOCIAL'										} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'18'																	, ; //X5_CHAVE
	'DARF SIMPLES'															, ; //X5_DESCRI
	'DARF SIMPLES'															, ; //X5_DESCSPA
	'DARF SIMPLES'															} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'19'																	, ; //X5_CHAVE
	'IPTU/ISS/OUTROS TRIBUTOS MUNICIPAIS'									, ; //X5_DESCRI
	'IPTU/ISS/OUTROS TRIBUTOS MUNICIPAIS'									, ; //X5_DESCSPA
	'IPTU/ISS/OUTROS TRIBUTOS MUNICIPAIS'									} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'58'																	, ; //X5_TABELA
	'22'																	, ; //X5_CHAVE
	'GARE – SP ICMS'														, ; //X5_DESCRI
	'GARE – SP ICMS'														, ; //X5_DESCSPA
	'GARE – SP ICMS'														} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'58'																	, ; //X5_TABELA
	'30'																	, ; //X5_CHAVE
	'PAGAMENTO DE TอTULOS EM COBRANวA NO ITAฺ'								, ; //X5_DESCRI
	'PAGAMENTO DE TอTULOS EM COBRANวA NO ITAฺ'								, ; //X5_DESCSPA
	'PAGAMENTO DE TอTULOS EM COBRANวA NO ITAฺ'								} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'31'																	, ; //X5_CHAVE
	'PAGAMENTO DE TอTULOS EM COBRANวA EM OUTROS BANCOS'						, ; //X5_DESCRI
	'PAGAMENTO DE TอTULOS EM COBRANวA EM OUTROS BANCOS'						, ; //X5_DESCSPA
	'PAGAMENTO DE TอTULOS EM COBRANวA EM OUTROS BANCOS'						} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'32'																	, ; //X5_CHAVE
	'NOTA FISCAL – LIQUIDAวรO ELETRิNICA'									, ; //X5_DESCRI
	'NOTA FISCAL – LIQUIDAวรO ELETRิNICA'									, ; //X5_DESCSPA
	'NOTA FISCAL – LIQUIDAวรO ELETRิNICA'									} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'TED – OUTRO TITULAR'													, ; //X5_DESCSPA
	'TED – OUTRO TITULAR'													} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'TED – MESMO TITULAR'													, ; //X5_DESCSPA
	'TED – MESMO TITULAR'													} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'60'																	, ; //X5_CHAVE
	'CARTรO SALมRIO'														, ; //X5_DESCRI
	'CARTรO SALมRIO'														, ; //X5_DESCSPA
	'CARTรO SALมRIO'														} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'58'																	, ; //X5_TABELA
	'91'																	, ; //X5_CHAVE
	'GNRE E TRIBUTOS COM CำDIGO DE BARRAS'									, ; //X5_DESCRI
	'GNRE E TRIBUTOS COM CำDIGO DE BARRAS'									, ; //X5_DESCSPA
	'GNRE E TRIBUTOS COM CำDIGO DE BARRAS'									} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'59'																	, ; //X5_TABELA
	'10'																	, ; //X5_CHAVE
	'DIVIDENDOS'															, ; //X5_DESCRI
	'DIVIDENDOS'															, ; //X5_DESCSPA
	'DIVIDENDOS'															} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'59'																	, ; //X5_TABELA
	'15'																	, ; //X5_CHAVE
	'DEBสNTURES'															, ; //X5_DESCRI
	'DEBสNTURES'															, ; //X5_DESCSPA
	'DEBสNTURES'															} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'59'																	, ; //X5_TABELA
	'20'																	, ; //X5_CHAVE
	'FORNECEDORES'															, ; //X5_DESCRI
	'FORNECEDORES'															, ; //X5_DESCSPA
	'FORNECEDORES'															} ) //X5_DESCENG
...
aAdd( aSX5, { ;
	...
	'59'																	, ; //X5_TABELA
	'40'																	, ; //X5_CHAVE
	'FUNDOS DE INVESTIMENTOS'												, ; //X5_DESCRI
	'FUNDOS DE INVESTIMENTOS'												, ; //X5_DESCSPA
	'FUNDOS DE INVESTIMENTOS'												} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'59'																	, ; //X5_TABELA
	'50'																	, ; //X5_CHAVE
	'SINISTROS DE SEGUROS'													, ; //X5_DESCRI
	'SINISTROS DE SEGUROS'													, ; //X5_DESCSPA
	'SINISTROS DE SEGUROS'													} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'59'																	, ; //X5_TABELA
	'60'																	, ; //X5_CHAVE
	'DESPESAS VIAJANTE EM TRยNSITO'											, ; //X5_DESCRI
	'DESPESAS VIAJANTE EM TRยNSITO'											, ; //X5_DESCSPA
	'DESPESAS VIAJANTE EM TRยNSITO'											} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'59'																	, ; //X5_TABELA
	'80'																	, ; //X5_CHAVE
	'REPRESENTANTES AUTORIZADOS'											, ; //X5_DESCRI
	'REPRESENTANTES AUTORIZADOS'											, ; //X5_DESCSPA
	'REPRESENTANTES AUTORIZADOS'											} ) //X5_DESCENG

aAdd( aSX5, { ;
	'  '																	, ; //X5_FILIAL
	'59'																	, ; //X5_TABELA
	'90'																	, ; //X5_CHAVE
	'BENEFอCIOS'															, ; //X5_DESCRI
	'BENEFอCIOS'															, ; //X5_DESCSPA
	'BENEFอCIOS'															} ) //X5_DESCENG
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuHlp บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
//
aHlpPor := {}
aAdd( aHlpPor, 'Digito Conta' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PA2_ZZNUMDC ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "A2_ZZNUMDC" + CRLF

//
// Helps Tabela SE2
//
aHlpPor := {}
aAdd( aHlpPor, 'Linha Digital do Boleto Bancario caso' )
aAdd( aHlpPor, 'nao seja possivel Leitura Optica.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_IPTE   ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_IPTE" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Saldo do Titulo ap๓s reten็ใo dos' )
aAdd( aHlpPor, 'impostos.' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZSALDO", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZSALDO" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Juros CNAB' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZJUROS", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZJUROS" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Valor Entidade' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZVLENT", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZVLENT" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'CNPJ Contribuinte' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZCNPJC ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZCNPJC" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Nome Contribuinte' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZCONTR ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZCONTR" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Apura็ใo' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZAPURA ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZAPURA" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Cod. Receita' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZCDREC ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZCDREC" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Multa CNAB' )
aHlpEng := {}
aHlpSpa := {}

PutHelp( "PE2_ZZMULTA ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_ZZMULTA" + CRLF

aHlpPor := {}
aAdd( aHlpPor, 'Dados referentes ao c๓digo de barras do' )
aAdd( aHlpPor, 'titulo ou linha digitแvel do mesmo.' )
aHlpEng := {}
aAdd( aHlpEng, 'Information referring to the barcode of' )
aAdd( aHlpEng, 'the heading or line typable of the same.' )
aHlpSpa := {}
aAdd( aHlpSpa, 'Datos referentes al codigo de barras del' )
aAdd( aHlpSpa, 'titulo o linea digitable del mismo.' )

PutHelp( "PE2_CODBAR ", aHlpPor, aHlpEng, aHlpSpa, .T. )
cTexto += "Atualizado o Help do campo " + "E2_CODBAR" + CRLF
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  11/03/2013 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
